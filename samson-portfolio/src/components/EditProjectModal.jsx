...
const EditProjectModal = ({ project, isOpen, onClose, onSubmit }) => {
  ...
  useEffect(() => {
    if (project) {
      setFormData({
        ...
        image: project.image || '',
        repoLink: project.github_url || project.repoLink || '',
        liveUrl: project.live_url || project.liveUrl || '',
        tech: (project.tags || project.tech || []).join(', '),
        problem: project.problem || '',
        techChoice: project.tech_choice || project.techChoice || '',
  ...
  return (
    ...
    >
      <motion.div
        layoutId="project-edit-modal-container"
