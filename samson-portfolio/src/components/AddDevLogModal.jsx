      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Title */}
            <div>
              <label htmlFor="devlog-title" className={`block text-sm font-mono uppercase tracking-widest mb-2 ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>
                Title *
              </label>
              <input
                type="text"
            ...
            {/* Snippet */}
            <div>
              <label htmlFor="devlog-snippet" className={`block text-sm font-mono uppercase tracking-widest mb-2 ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>
                Snippet *
              </label>
              <input
                type="text"
            ...
            {/* Content */}
            <div>
              <label htmlFor="devlog-content" className={`block text-sm font-mono uppercase tracking-widest mb-2 ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>
                Full Content *
              </label>
              <textarea
                id="devlog-content"
                ...
                placeholder="Write the full developer log here..."
              />
            </div>
            ...
            <div className="flex justify-end pt-6">
              <button
                type="submit"
                className={`px-8 py-3 rounded-lg font-mono uppercase tracking-widest transition-all duration-300 ${isDark ? 'bg-orange-500 text-white hover:bg-orange-600' : 'bg-orange-500 text-white hover:bg-orange-600'}`}
              >
                Add Dev Log
              </button>
            </div>
